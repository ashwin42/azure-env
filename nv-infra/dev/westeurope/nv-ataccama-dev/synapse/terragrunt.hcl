...
inputs = {
  ...
  storage_data_lake_gen2_filesystem_id = "https://dlmasterdataataccamadev.dfs.core.windows.net/dlmasterdataataccamadev-dl"
...
{
  "connectionString": "Server=tcp:nvataccamamasterdatadev.database.windows.net,1433;Initial Catalog=ivaluadev;Persist Security Info=False;User ID=ataccama_sql_ivalua_user;Password=;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
}
JSON
  },
]
