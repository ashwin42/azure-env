resource "azurerm_availability_set" "nv_labx2_avs" {
  name                = "nv_labx2_avs"
...
resource "azurerm_virtual_machine" "main" {
  ...
  availability_set_id              = azurerm_availability_set.nv_labx2_avs.id
  ...
  settings           = <<SETTINGS
        {
            ...
            "Restart": "true",
            "Options": "3",
						"OUPath": "OU=AADDC Computers,DC=aadds,DC=northvolt,DC=com"
        }
SETTINGS
