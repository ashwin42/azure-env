resource "azurerm_recovery_services_vault" "nv-polarion" {
  name                = "nv-polarion-recovery-vault"
...
resource "azurerm_recovery_services_protection_policy_vm" "daily" {
  name                = "daily"
  resource_group_name = var.resource_group_name
  recovery_vault_name = azurerm_recovery_services_vault.nv-polarion.name
