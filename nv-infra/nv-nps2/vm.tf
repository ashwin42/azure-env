...
resource "azurerm_recovery_services_protected_vm" "main" {
  ...
  backup_policy_id    = "/subscriptions/11dd160f-0e01-4b4d-a7a0-59407e357777/resourceGroups/nv_nps/providers/Microsoft.RecoveryServices/vaults/nv-nps-recovery-vault/backupPolicies/daily"
}
