locals {
  ...
  grafana_secret_aws_region  = local.aws_region
  # aviatrix
  ...
  aviatrix_secret_aws_region  = local.aws_region
  ...
  restapi_secret_aws_region  = local.aws_region
  ...
  panos_secret_aws_region  = local.aws_region
  # netbox
