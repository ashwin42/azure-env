...
provider "registry.terraform.io/betr-io/mssql" {
  ...
  constraints = ">= 0.2.5"
  hashes = [
    "h1:OdGVN0hIT7zDvypkpPoVmTNwJFfXDNQDdpjnCNVJM4g=",
    "h1:QHD9qo0weoc/8LrCe7+y+mHLNo+2hY7Tf4kmzq9SWMo=",
    "h1:QM/xUW87//dS2wMREJn5JUZWEMMuv2QA8FDJFfnzEGg=",
...
provider "registry.terraform.io/e-breuninger/netbox" {
  ...
  constraints = "3.6.2"
  hashes = [
    "h1:GXzCw48HYVUGWWXQ/aMjjWe00sBWLFIS+9w3pmfnXLo=",
    "h1:WCvqfhv4NMwyMXp9D4xgyic1ZuRwKxTXKksPgxssZjw=",
...
provider "registry.terraform.io/hashicorp/azurerm" {
  version     = "3.76.0"
  constraints = ">= 2.99.0, >= 3.0.0, >= 3.22.0"
  hashes = [
